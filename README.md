...
The goal? Create a simple&cheap, but high precision, solution for *augmented starhopping*: point the scope to something you can find and move to a remote, low magnitude object.
