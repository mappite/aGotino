...
aGotino allows precise tracking and *augmented starhopping*: you point the scope to something you can easily find and get help to reach a remote, low magnitude object nearby - default *nearby* is 30° so you should always find some bright stars around! This *hybrid-goto* solution requires no star alignment procedure to work and you can move and rotate your scope freely until you need that extra help. Because no star alignment is required, goto functionality may not be as precise as other solutions however within the default 30° the hardware&software accuracy proved to point any object with an error below 15' (half moon size), more than enough to spot it using a mid-focal eyepiece. At the benefit of not having to be locked to always use goto.
